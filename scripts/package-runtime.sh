...
for required in codeblocks.js codeblocks-module.js codeblocks.css editor.js simple.js ansi.js grammars/c.js grammars/cpp.js wasm/clangd.js wasm/clangd.wasm; do
